        ...
        {step === 3 && (
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-end gap-3 pt-4">
                <LoadingButton type="button" variant="secondary" onClick={handleBack} disabled={isLoading}>
                  {t('cancel')}
                </LoadingButton>
                <LoadingButton type="button" isLoading={isLoading} variant="success" onClick={handleConfirm}>
                  {t('confirmOrder')}
                </LoadingButton>
              </div>
            </div>
